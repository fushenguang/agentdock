---
title: Skills
description: 在 AgentDock 中理解、设计和管理 AI 编程 Skills
---
...
- [Builder Workflow](/zh/docs/builder-workflow) - 了解四门工作流模型
- [OpenSpec Guide](/zh/docs/cli/openspec) - 规范驱动开发
- [Integration Testing](/zh/docs/testing) - 自动化测试策略
