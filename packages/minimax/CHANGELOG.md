...
- b55a1ce: Add `@cogito.ai/minimax`, a typed and testable MiniMax media-generation client (image, music, video) with byte-only outputs (never a MiniMax URL), a duck-typed `classifyError`, and quota helpers (`isQuotaExhausted`, `msUntilReset`).
