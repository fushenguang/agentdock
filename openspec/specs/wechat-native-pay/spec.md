# wechat-native-pay Specification

## Purpose

TBD - created by archiving change add-payments-to-web-nextjs. Update Purpose after archive.
...
WECHAT_PAY_PRIVATE_KEY=<your merchant private key, PKCS8 PEM format>
