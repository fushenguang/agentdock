...
Define the routing structure and middleware protection for authenticated and unauthenticated areas of the application. This capability ensures proper session validation, route group separation, and automatic token refresh.
