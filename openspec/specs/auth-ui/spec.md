...
Define the UI components and forms for authentication flows using shadcn/ui blocks. This capability covers login, signup pages, form validation with react-hook-form + zod, and internationalized auth copy.
