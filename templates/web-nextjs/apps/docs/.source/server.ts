...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "decisions/meta.json": __fd_glob_1, "features/meta.json": __fd_glob_2, "changelog/meta.json": __fd_glob_3, "roadmap/meta.json": __fd_glob_4, }, {"index.mdx": __fd_glob_5, "changelog/index.mdx": __fd_glob_6, "features/hello.mdx": __fd_glob_7, "roadmap/index.mdx": __fd_glob_8, });